	...
	const [routes] = React.useState([
		{
			...
			title: 'Home',
			focusedIcon: () => (
				<Image source={icons.homeActive} style={styles.icon} />
			),
		...
		},
		{
			...
			title: 'Tasks',
			focusedIcon: () => (
				<Image source={icons.taskActive} style={styles.icon} />
			),
		...
		},
		{
			...
			title: 'Profile',
			focusedIcon: () => (
				<Image source={icons.profileActive} style={styles.icon} />
			),
		...
		},
		{
			...
			title: 'Settings',
			focusedIcon: () => (
				<Image source={icons.settingsActive} style={styles.icon} />
			),
			unfocusedIcon: () => (
